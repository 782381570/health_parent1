...
public class MessageConstant {
    ...
    public static final String GET_PERMISSION_LIST_FAIL = "查询权限列表数据失败";
    public static final String GET_PERMISSION_LIST_SUCCESS = "查询权限列表数据成功";
    public static final String QUERY_PERMISSION_LIST_FAIL = "查询权限数据失败";
    public static final String QUERY_PERMISSION_LIST_SUCCESS = "查询权限数据成功";
    public static final String DELETE_PERMISSION_LIST_FAIL = "删除权限数据失败";
    public static final String DELETE_PERMISSION_LIST_SUCCESS = "删除权限数据成功";
    public static final String EDIT_PERMISSION_LIST_FAIL = "编辑权限数据失败";
    public static final String EDIT_PERMISSION_LIST_SUCCESS = "编辑权限数据成功";
    ...
    public static final String ADD_MENU_FALL = "新增菜单失败";
    public static final String EDIT_MENU_SUCCESS = "编辑菜单成功";
    public static final String EDIT_MENU_FALL = "编辑菜单失败";
